...
const ja = {
  ...
  today: "今日",
  calendarMenu: "表示設定",
  calendarDisplayTitle: "表示",
  showCategory: "項目を表示",
  showMemo: "メモを表示",
  showAdjacentDays: "前後の月の日付を表示",
  showMonthTotal: "合計金額を表示",
  displayTotal: "合計",
  displayAdjacent: "前後の月",
  weekdaySun: "日",
  weekdayMon: "月",
  weekdayTue: "火",
  weekdayWed: "水",
...
const en: { [K in keyof typeof ja]: string } = {
  ...
  today: "Today",
  calendarMenu: "Display options",
  calendarDisplayTitle: "Display",
  showCategory: "Show tags",
  showMemo: "Show memos",
  showAdjacentDays: "Show other-month dates",
  showMonthTotal: "Show month total",
  displayTotal: "Total",
  displayAdjacent: "Other months",
  weekdaySun: "Sun",
  weekdayMon: "Mon",
  weekdayTue: "Tue",
  weekdayWed: "Wed",
